...
export class CheckoutPage extends BasePage {
	...
	constructor(page: Page) {
		...
		this.billingAddressInput = this.container.getByTestId('billing-address-input');
		this.billingCityInput = this.container.getByTestId('billing-city-input');
		this.billingCompanyInput = this.container.getByTestId('billing-company-input');
		this.billingFirstNameInput = this.container.getByTestId(
			'billing-first-name-input'
		);
		this.billingLastNameInput = this.container.getByTestId('billing-last-name-input');
		...
		this.billingProvinceInput = this.container.getByTestId('billing-province-input');
		this.shippingAddressInput = this.container.getByTestId('shipping-address-input');
		...
		this.billingCountrySelect = this.container.getByTestId('billing-country-select');
		...
		this.submitAddressButton = this.container.getByTestId('submit-address-button');
		this.addressErrorMessage = this.container.getByTestId('address-error-message');

		this.deliveryOptionsContainer = this.container.getByTestId(
			'delivery-options-container'
		);
		this.deliveryOptionRadio = this.container.getByTestId('delivery-option-radio');
		...
		this.paymentMethodSummary = this.container.getByTestId('payment-method-summary');
		...
		this.submitPaymentButton = this.container.getByTestId('submit-payment-button');
		...
		this.discountApplyButton = this.container.getByTestId('discount-apply-button');
		this.discountErrorMessage = this.container.getByTestId('discount-error-message');
		...
		this.giftCardRemoveButton = this.container.getByTestId('remove-gift-card-button');
		this.cartSubtotal = this.container.getByTestId('cart-subtotal');
		this.cartDiscount = this.container.getByTestId('cart-discount');
		this.cartGiftCardAmount = this.container.getByTestId('cart-gift-card-amount');
		...
		this.itemUnitReducedPrice = this.container.getByTestId('item-unit-reduced-price');
	}
