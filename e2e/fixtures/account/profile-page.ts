...
export class ProfilePage extends AccountPage {
	...
	constructor(page: Page) {
		...
		this.passwordEditButton = this.accountPasswordEditor.getByTestId('edit-button');
		...
		this.passwordSaveButton = this.accountPasswordEditor.getByTestId('save-button');
		...
		this.nameSuccessMessage = this.accountNameEditor.getByTestId('success-message');
		this.emailSuccessMessage = this.accountEmailEditor.getByTestId('success-message');
		this.phoneSuccessMessage = this.accountPhoneEditor.getByTestId('success-message');
		...
		this.emailErrorMessage = this.accountEmailEditor.getByTestId('error-message');
		this.phoneErrorMessage = this.accountPhoneEditor.getByTestId('error-message');
		...
		this.billingPostcalCodeInput = page.getByTestId('billing-postcal-code-input');
		this.billingProvinceInput = page.getByTestId('billing-province-input');
		this.billingCountryCodeSelect = page.getByTestId('billing-country-code-select');
	}
	...
	async getEditorInputs(editor: Locator) {
		...
		// get all the inputs
		const inputs = editor.locator('[data-testid]:not([data-testid="edit-button"])');
		const o = {
			editButton,
		} as { [k: string]: Locator };
